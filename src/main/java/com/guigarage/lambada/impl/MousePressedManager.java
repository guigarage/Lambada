...
public class MousePressedManager extends EventHandlerManager<MouseEvent, FunctionalEventHandler<? super MouseEvent>, MouseListener, Component> {

    public MousePressedManager() {
