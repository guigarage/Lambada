...
public class MouseMovedManager extends EventHandlerManager<MouseEvent, FunctionalEventHandler<? super MouseEvent>, MouseMotionListener, Component> {

    public MouseMovedManager() {
