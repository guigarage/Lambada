 ...
 */
public class FocusGainedManager extends EventHandlerManager<FocusEvent, FunctionalEventHandler<? super FocusEvent>, FocusListener, Component> {

    public FocusGainedManager() {
